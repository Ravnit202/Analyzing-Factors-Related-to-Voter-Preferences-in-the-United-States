---
title: "Analyzing Factors in Relation to Voter Preferences in the United States"
author: Ravnit Lotay
date: "today"
date-format: long
abstract: "This study investigates the factors influencing voter support in the 2022 US presidential election, utilizing logistic regression on CCES 2022 data."
format: pdf
toc: true
...
## Model Creation
To create the model, $y_i$ can be defined as the respondent’s political preference. This is equal to 1 for Trump and 0 for Biden. Then, gender can be defined via $mq_i$, and $mq_age$ to be their age. We can estimate these parameters using $stem()$.
